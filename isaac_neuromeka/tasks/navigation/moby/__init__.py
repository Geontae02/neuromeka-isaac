...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": f"{learning.__name__}.rsl_rl_cfg:ReachPPORunnerCfg",  # PPO 학습 설정 변경
        "nrmk_rl_cfg_entry_point": f"{learning.__name__}.nrmk_rl_cfg:ReachPPORunnerCfg",  # NRMK 학습 설정 변경
